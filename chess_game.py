# Schaakspel met uitgebreid hoofdmenu, foutfix en gameplay
import pygame
import chess
import chess.engine
import os
...
def draw_history():
    ...
    y = 480
    text = font.render("Zetgeschiedenis:", True, (255, 255, 255))
    screen.blit(text, (10, y))
    for i, move in enumerate(move_history[-4:]):
        text = font.render(move, True, (200, 200, 200))
        screen.blit(text, (10, y + 20 + i*20))
...
def ai_move():
    ...
    if not board.is_game_over():
        ...
        move_history.append(board.san(last_move))
